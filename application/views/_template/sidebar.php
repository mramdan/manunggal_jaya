        ...
        <div class="aside-menu overflow-hidden">
            ...
            <nav id="stacked-menu" class="stacked-menu">
                ...
                <ul class="menu">
                    ...
                    <li class="menu-item">
                        <a href="<?= base_url('admin/set_profile') ?>" class="menu-link"><span class="menu-icon fas fa-rocket"></span> <span class="menu-text">Setting Profile</span></a>
                    </li>
                    <li class="menu-item has-child">
                        <a href="#" class="menu-link"><span class="menu-icon oi oi-wrench"></span> <span class="menu-text">Setting Profile</span></a> <!-- child menu -->
                        <ul class="menu">
                            <li class="menu-item">
                    ...
                    <li class="menu-header">Setup Website </li><!-- /.menu-header -->
                    <!-- .menu-item -->
                    <li class="menu-item has-child">
