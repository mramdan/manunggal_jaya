...
<script src="<?= base_url() ?>assets/backend/vendor/chart.js/Chart.min.js"></script> <!-- END PLUGINS JS -->
<!-- BEGIN THEME JS -->
<script src="<?= base_url() ?>assets/backend/javascript/theme.min.js"></script> <!-- END THEME JS -->
<!-- BEGIN PAGE LEVEL JS -->
<script src="<?= base_url() ?>assets/backend/javascript/pages/dashboard-demo.js"></script> <!-- END PAGE LEVEL JS -->
